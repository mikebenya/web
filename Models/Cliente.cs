...
{
[Key][JsonProperty("cliente_id")][DatabaseGenerated(DatabaseGeneratedOption.None)] public string CLIENTE_ID { get; set; }
...
[JsonProperty("cliente_fechaN")] public DateTime CLIENTE_FECHAN { get; set; }
...
[JsonProperty("facturaMaestros")] public virtual List<FacturaMaestro> facturaMaestros { get; set; }
}
